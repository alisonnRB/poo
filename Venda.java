...
class Venda {
	ArrayList<Produto> itens;	// vetor de produtos (armazenada vários produtos)
	...
	public void adicionarItem(Produto item){
		itens.add(item);	// adiciona o produto ao vetor "itens"
	...
	public void visualizarVenda(){
		...
		for (int i=0; i < indice; i++) {
			itens.get(indice);	// usa a variavel i para poder chamar o método mostrar()
		} 
